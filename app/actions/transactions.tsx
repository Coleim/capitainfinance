...
export const updateTransaction = (transaction: Transaction) => ({ type: transaction.isReccuring ? UPDATE_RECURRING_TRANSACTION : UPDATE_TRANSACTION, transaction });
export const addTransaction = (label: string, amount: number, category: string, recurring: boolean = false) => ({ 
