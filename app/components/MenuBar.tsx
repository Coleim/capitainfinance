  ...
  return (
    ...
    <View style={{ height: 70 }} >
      <View style={{ flexDirection: "row", justifyContent: "flex-start", alignContent: "flex-start", alignSelf: 'center', backgroundColor: '#303030', 
        ...
        <Ionicons name="md-arrow-up-circle" size={70} color="#1ee9a4" style={{zIndex: 3, bottom: 20, height: 70 }} onPress={ () => addIncome() } />
        <Ionicons name="md-arrow-down-circle" size={70} color="#e91e63" style={{zIndex: 3, bottom: 20, height: 70}} onPress={ () => addExpense() } />
      </View>
